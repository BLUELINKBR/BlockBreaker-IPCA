...
namespace Game1
{
    public class BlocoAzul : TexturedPrimitive
    {
        private Vector2 mDeltaPosition; // Change current position by this amount
        public bool existe;
        public BlocoAzul(Vector2 position, Vector2 size) :
        base(Game1.sContent.Load<Texture2D>("Block Breaker Bloco Azul"), position, size)
        {
        ...
        public void CheckCollision(Esfera esfera)
        {
