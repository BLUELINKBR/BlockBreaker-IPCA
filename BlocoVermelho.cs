...
namespace Game1
{
    public class BlocoVermelho : TexturedPrimitive
    {
        private Vector2 mDeltaPosition; // Change current position by this amount
        public bool existe;
        public BlocoVermelho(Vector2 position, Vector2 size) :
        base(Game1.sContent.Load<Texture2D>("Block Breaker Bloco Vermelho"), position, size)
        {
