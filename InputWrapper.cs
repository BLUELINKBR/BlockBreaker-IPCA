...
namespace Game1
{
    ...
    internal struct AllInputButtons
    {
        ...
        private const Keys kBack_ButtonKey = Keys.Escape;
        private const Keys kStart_ButtonKey = Keys.Enter;
    ...
    {
        const Keys kLeftThumbStickUp = Keys.Up;
        const Keys kLeftThumbStickDown = Keys.Down;
        const Keys kLeftThumbStickLeft = Keys.Left;
        const Keys kLeftThumbStickRight = Keys.Right;

        const Keys kRightThumbStickUp = Keys.W;
        const Keys kRightThumbStickDown = Keys.S;
        const Keys kRightThumbStickLeft = Keys.A;
        const Keys kRightThumbStickRight = Keys.D;
        ...
        public Vector2 Left
        {
            get
            {
                return ThumbStickState(GamePad.GetState(PlayerIndex.One).ThumbSticks.Left,
                                            0, 0, kLeftThumbStickLeft, kLeftThumbStickRight);
            }
        }
